...
train_dataset = MyDataset("imdb_train")
val_dataset = MyDataset("imdb_test")
...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCH):
        ...
        torch.save(model.state_dict(), f"../trained_models/params/bert-config-{epoch}.pth") # save the model at each epoch
